...
const Verification = ({ length = 6, onOtpSubmit = () => { }, callback="/info" }) => {
	...
	return (
      ...
      <div className="fixed-screen flex-col flex-center">
        ...
        <p className="text-xs mt-12 text-center"><Link to="/" className="text-green-600 underline">Click Me</Link> <br /> to change the phone number</p>
